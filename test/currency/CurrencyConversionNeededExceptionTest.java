...
class CurrencyConversionNeededExceptionTest {
    ...
    @Test
    void testGetMessageInstanceFromFirstAuxConstructor() {
        CurrencyAmount amountA = makeAmount();
        CurrencyAmount amountB = makeAmountDiffCurrency(amountA.getCurrency());
        CurrencyConversionNeededException instance
                = new CurrencyConversionNeededException(amountA, amountB);
        String expected = "Conversion needed for operation with " + amountA
                + " and " + amountB;
        String actual = instance.getMessage();
        assertEquals(expected, actual);
    }
    ...
    @Test
    void testGetMessageInstanceFromSecondAuxConstructor() {
        CurrencyAmount amountA = makeAmount();
        Currency currency = CurrencyChooser
                .chooseCurrencyOtherThan(amountA.getCurrency());
        CurrencyConversionNeededException instance
    ...
    @Test
    void testGetAmountAOnInstanceFromSecondAuxConstructor() {
        CurrencyAmount expected = makeAmount();
        Currency currency
                = CurrencyChooser.chooseCurrencyOtherThan(expected
                .getCurrency());
        CurrencyConversionNeededException instance
                = new CurrencyConversionNeededException(expected, currency);
        CurrencyAmount actual = instance.getAmountA();
        String message = "Expecting amount of "
                + expected.getCurrency().getDisplayName() + " ("
                + expected.getCurrency().getCurrencyCode() + ")";
    ...
    @Test
    void testGetAmountBOnInstanceFromFirstAuxConstructor() {
        CurrencyAmount amountA = makeAmount();
        CurrencyAmount expected = makeAmountDiffCurrency(amountA.getCurrency());
        CurrencyConversionNeededException instance
                = new CurrencyConversionNeededException(amountA, expected);
    ...
    @Test
    void testGetAmountBOnInstanceFromSecondAuxConstructor100Cents() {
        CurrencyAmount amountA = makeAmount();
        Currency currA = amountA.getCurrency();
        Currency currency = CurrencyChooser.chooseCurrency(
                (cur) -> !cur.equals(currA)
    ...
    @Test
    void testGetAmountBOnInstanceFromSecondAuxConstructor10000Divisions() {
        CurrencyAmount amountA = makeAmount();
        Currency currA = amountA.getCurrency();
        Currency currency = CurrencyChooser.chooseCurrency(
                (cur) -> !cur.equals(currA)
                        && cur.getDefaultFractionDigits() == 4
        );
        CurrencyConversionNeededException instance
                = new CurrencyConversionNeededException(amountA, currency);
        CurrencyAmount expected = new CurrencyAmount(10000, currency);
        CurrencyAmount actual = instance.getAmountB();
        String message = "As amount of currency " + currency.getDisplayName()
                + " (" + currency.getCurrencyCode()
                + ") was not specified, expecting one unit of that currency";
